...
(setq machine-config-list
  '((theme-style (white-theme-machine white))
    ...
    (installable-packages
     ...
     (basic (vlf magit dash multi-term counsel async wgrep which-key paredit poporg ctrlf expand-region company vterm clipetty))
     (documentation (org-fragtog auctex latex-preview-pane pdf-tools define-word pdfgrep biblio))
