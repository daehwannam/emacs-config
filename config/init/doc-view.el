...
(use-existing-pkg doc-view
  :config
  (progn
    (progn
      (setq doc-view-scroll-small-height 3)

      (defun dhnam/doc-view-scroll-up-or-next-page-small (&optional arg)
...
Otherwise, goto next page only on typing SPC (ARG is nil)."
      ...
      (defun dhnam/doc-view-scroll-down-or-previous-page-small (&optional arg)
...
Otherwise, goto previous page only on typing DEL (ARG is nil)."
      ...
      (comment
       (define-key doc-view-mode-map (kbd "C-v") 'dhnam/doc-view-scroll-up-or-next-page-small)
       (define-key doc-view-mode-map (kbd "M-v") 'dhnam/doc-view-scroll-down-or-previous-page-small)))

    (progn
      (setq doc-view-num-next-prev-lines 3)
      (setq doc-view-continuous t)

      (defun dhnam/doc-view-next-line-or-next-page-small (&optional arg)
...
at the bottom edge of the page moves to the next page."
      ...
      (defun dhnam/doc-view-previous-line-or-previous-page-small (&optional arg)
