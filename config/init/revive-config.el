(comment
  ...
  (unless (file-exists-p (concat dhnam/emacs-root-dir "layout/"))
    ...
    (make-directory (concat dhnam/emacs-root-dir "layout/")))

  (defun dhnam/revive-layout-read-args (prompt mustmatch)
    (list (read-file-name prompt (concat dhnam/emacs-root-dir "layout/") nil mustmatch)))
