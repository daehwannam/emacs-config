...
(setq dhnam/machine-config-list
      '((theme-style (white-theme-machine white))
        ...
        (installable-packages
         ...
         (programming (realgud markdown-mode sphinx-doc ein hy-mode jsonnet-mode csv-mode lice slime sly hl-todo))
         ...
         (gui-setup (atomic-chrome))
         (exwm-setup (exwm volume hide-mode-line ivy-posframe which-key-posframe exwm-edit pulseaudio-control))
